...
const CreateRecipesComponent = () => {
    ...
    return (
        <div className="pt-1">
            ...
            {/*}*/}
            {currentUser &&
             <div className="pb-5 create-recipe-section">
                 <h4 className="wd-create-recipe-title pb-2">
                     Create your very own recipe
                 </h4>
                 <Link to="/createRecipe"
                       className="text-decoration-none text-light">
                     <button className="btn btn-success rounded-pill">
                         <span className="wd-btn-create">Whip up</span>
                     </button>
                 </Link>

             </div>
            }
            <h4 className="mt-4 mb-3 wd-recipe-list">
                Let's see what people are whipping up
                <i className="bi bi-cup-hot-fill ms-3"></i>
            </h4>
            <div className="row">
                {
                    recipes.map((recipe) =>
                                    ...
                                    col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6"
                                        ...
                                        <div className="card" style={{width: "21rem"}}>
                                            ...
                                            ${recipe.author.type === "PRO" ? 'card-pro' : ''}
                                            `}>
                                                ...
                                                {currentUser &&
                                                 <>
                                                     <i onClick={() => {
                                                        ...
                                                        className={`float-start bi bi-bookmark-fill me-2 card-link
